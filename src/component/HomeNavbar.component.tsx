...
function HomeNavbar({
	...
	return (
		<nav className='flex w-full items-center justify-center font-main mt-5 md:mt-10 fixed top-0 left-0 z-50 px-4'>
			<ul className='flex text-sm md:text-xl gap-2 md:gap-4 shadow-xl rounded-full p-2 md:p-3 bg-main text-contrast shadow-shade-shadow transition-all duration-300'>
				{items}
			</ul>
		</nav>
	)
