	...
	return (
		...
		>
			<div className='flex gap-2 flex-1 justify-center flex-col md:ml-40 text-center md:text-left items-center md:items-start'>
				...
				<Link
					className='px-5 py-3 md:px-6 md:py-4 bg-primary w-fit rounded-full text-lg md:text-xl mt-3 hover:bg-shade hover:text-accent hover:border-accent border-2 transition-all duration-300 font-main border-transparent'
					to={ROUTES.MAIN}
				>
					Try now
				</Link>
